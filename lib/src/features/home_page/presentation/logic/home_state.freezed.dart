...
abstract class _Data implements HomeState {
  const factory _Data(final dynamic data) = _$_Data;
...
class _$_Error implements _Error {
  const _$_Error({required this.errorModel});
  ...
  @override
  String toString() {
    return 'HomeState.error(errorModel: $errorModel)';
  }
...
abstract class _Error implements HomeState {
  const factory _Error({required final ErrorModel errorModel}) = _$_Error;
